  ...
  return <><Nav/><main>
    <section className="hero hero-editorial container">
      <div className="hero-editorial-inner">
        ...
        <h1>Make the product work harder for the <span className="hero-word-window" aria-label="business, customer, team and next stage"><span className="hero-word-stack"><em>business.</em><em>customer.</em><em>team.</em><em>next stage.</em><em>business.</em></span></span></h1>
        <div className="hero-editorial-bottom"><p className="hero-copy">I help early-stage HRTech founders when product strategy, execution or operations have become the bottleneck — stepping in as the senior product leader you need, without another full-time executive hire.</p><div className="actions"><Link className="button primary" href="/contact">Let's talk ↗</Link><a className="text-link" href="#work">See the work ↓</a></div></div>
      </div>
    </section>
    <section className="logo-strip" aria-label="Selected company experience"><div className="container logo-strip-inner"><span>Experience across</span><div className="logo-cloud"><img src="/logos/personio.png" alt="Personio"/><img src="/logos/factorial.jpeg" alt="Factorial"/><img src="/logos/Leapsome.png" alt="Leapsome"/><img src="/logos/runa.png" alt="Runa"/><img src="/logos/potentialu.png" alt="PotentialU"/><img src="/logos/cubic.jpg" alt="Cubic.Art"/><img src="/logos/oneclimate.jpeg" alt="OneClimate"/></div></div></section>
    ...
    <section className="section meet-stef" id="stef"><div className="container meet-stef-grid"><Portrait className="meet-portrait"/><div className="meet-stef-copy"><div className="kicker">Meet Stef</div><h2>I’ve been on both sides of the product table.</h2><p>I’m <strong>Stefanie Stanislawski</strong> — a product leader, operator and former founder with 15+ years across HR, HRTech and product. I step into early-stage teams when product needs senior leadership, clearer decisions and stronger execution.</p><div className="stef-stats"><div><strong>15+ years</strong><span>HR, HRTech & product</span></div><div><strong>Founder → Product Leader</strong><span>Built my own company before advising others</span></div><div><strong>Europe + LatAm</strong><span>International product leadership</span></div></div><AboutOverlay/></div></div></section>
