...
export async function generateMetadata({params}){
  ...
  return {
    ...
    openGraph:{title:item.metaTitle,description:item.metaDescription,images:[{url:'https://www.productpulseconsulting.com/opengraph-image',width:1200,height:630,alt:'Product Pulse — Fractional Product Leadership for HRTech Startups'}]},twitter:{card:'summary_large_image',images:['https://www.productpulseconsulting.com/og-image.svg']}
  }
}
