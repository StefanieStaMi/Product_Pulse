...
export const metadata={
  ...
  openGraph:{title:'Contact Stefanie — Fractional Product Leadership for HRTech',description:'Talk to Stefanie about fractional product leadership, product operations or a product challenge inside your HRTech startup.',url:'https://www.productpulseconsulting.com/contact',images:[{url:'/opengraph-image',width:1200,height:630,alt:'Product Pulse — Fractional Product Leadership for HRTech Startups'}]},
